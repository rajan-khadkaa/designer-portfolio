...
function RenderImage({ section }: { section: SectionImage }) {
  ...
  return (
    <figure className="my-2">
      <div className="w-full border border-border bg-bg-2">
        <img
          src={section.src}
          alt={section.alt}
...
function RenderBeforeAfter({ section }: { section: SectionBeforeAfter }) {
  return (
    <figure className="my-2 flex flex-col gap-4">
      {/* Before/Old Mockup */}
      <div className="relative w-full border border-border bg-bg-2">
        <img
...
export default function CaseStudyClient({ study }: CaseStudyClientProps) {
  ...
  return (
    <>
      ...
      <main>
        {/* ── Hero image ── */}
        <div className="w-full relative overflow-hidden h-[40vh]" >
          <Image
            src={study.heroImage}
